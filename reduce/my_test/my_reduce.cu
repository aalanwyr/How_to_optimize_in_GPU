...
void run(int kernel_index, int block_num, dim3 Grid,dim3 Block,float *device_a ,float *device_out,float *host_out,float *res) {
...
int main() {
    ...
    // run kernel
    run(0,block_num, Grid, Block, device_a, device_out, host_out, res);

    //  clean the ptr
    memset(host_out,0,block_num*sizeof(float));
    cudaMemset(device_out,0,block_num*sizeof(float));
    run(1,block_num, Grid, Block, device_a, device_out, host_out, res);


    //  clean the ptr
    memset(host_out,0,block_num*sizeof(float));
    cudaMemset(device_out,0,block_num*sizeof(float));
    run(2,block_num, Grid, Block, device_a, device_out, host_out, res);

    //  clean the ptr
    memset(host_out,0,block_num*sizeof(float));
    cudaMemset(device_out,0,block_num*sizeof(float));
    run(3,block_num, Grid, Block, device_a, device_out, host_out, res);

    //  clean the ptr
    memset(host_out,0,block_num*sizeof(float));
    cudaMemset(device_out,0,block_num*sizeof(float));
    run(4,block_num, Grid, Block, device_a, device_out, host_out, res);
    ...
    run(5,block_num_, Grid_, Block_, device_a, device_out_, host_out_, res_);
